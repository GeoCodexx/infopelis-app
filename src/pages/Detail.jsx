...
const Detail = () => {
  ...
  return (
    <div className={`container mx-auto pt-14 ${darkMode ? "dark-body" : ""}`}>
      {movie && (
        <>
          <div
          ...
          >
            <div className="image_movie col-span-1">
              ...
              />
              {movie.overview && (
                <div className="box-btn-trailer text-center mt-3">
                  <button
          ...
          <div className="container mt-8">
            <div className="cast-scroller">
              <h2 className="font-semibold text-xl mb-1 text-center sm:text-start sm:pl-2 md:pl-0">
                Reparto Principal
              </h2>
